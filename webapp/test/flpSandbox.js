		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#kendorleeemployee3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kendorleeemployee3-display": {
								"semanticObject": "kendorleeemployee3",
								"action": "display",
								"description": "An SAP Fiori application. Basic UI5 List w/NWind",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kendorlee.employee3",
									"url": sap.ui.require.toUrl("kendorlee/employee3")
								}
							}
						}
					}
